  ...
  return (
    <ul className="specifications-list">
      ...
      <div className="specifications-button-container">
        <button type="button" className="specifications-button" onClick={isProductInCart ? navigateToCart : addProductsToCart}>{isProductInCart ? 'Go To Cart' : 'Add to Cart'}</button>
